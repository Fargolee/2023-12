...
if __name__ == '__main__':
    db = {
        ...
        'host': 'rt-beta01.beta1.fn',
        'user': 'su_ro_supplier_jc',
        'password': 'WuM5EnZuVYSK',
        'port': 3306,
        'db': 'rt_supplier_jc',
        'charset': 'utf8'
    }
    db = DoMysql(db)
    sql = 'SELECT * from zt_supplier_flow where nt_status = 1 limit 10'
    res = db.get_one(sql)
    # res = db.get_many(sql, size=20)
    print(res)